...
class RvFavorite(private val listOfFavorites: MutableList<SeedSchema>) : RecyclerView.Adapter<RvFavorite.FavoriteViewHolder>() {

    class FavoriteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val favoriteCardView: MaterialCardView = itemView.findViewById(R.id.favoriteCardView)
        val favoriteAppName: TextView = itemView.findViewById(R.id.favoriteAppName)
    }
